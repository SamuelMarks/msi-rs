...
//!
//! Provides pure-Rust, memory-safe MD5 hashing specifically for Windows Installer
//! `FileHash` table calculations without requiring external unverified dependencies.
...
pub fn compute_md5(input: &[u8]) -> [u8; 16] {
    ...
    // Padding: append 0x80, then zeroes until len % 64 == 56, then 64-bit length
